...
const STR = {
  th: {
    ...
    getReady: "เข้าท่าเตรียม: แขนเหยียด ลำตัวตรง แล้วเริ่มวิดได้เลย",
    readyGo: "พร้อม! เริ่มนับ",
  ...
  en: {
    ...
    tracking: "Tracking…",
    getReady: "Get into position: arms straight, body level, then start",
    readyGo: "Ready! Counting",
